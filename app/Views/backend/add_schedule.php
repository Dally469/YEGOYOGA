	...
	<div class="row">
		<div class="col-md-5">
			...
			<div class="card">
				...
				<div class="card-body">
					<form action="<?=base_url('manipulate_schedule');?>" method="POST" class="singup-form">
						<div class="row">
							...
							<div class="col-md-12" >
								...
								<input type="time" name="fromtime" class="form-control" placeholder="Time From eg: 11:00 AM ">
							</div>
							<label class="col-sm-12 col-sm-12 control-label"> <strong>Set Time to</strong> </label>
							<div class="col-md-12">

								<input type="time" name="totime" class="form-control" placeholder="Time From eg: 11:00 PM ">
							</div>
							...
							<div class="col-md-12">
								<input type="submit" class="btn btn-info btn-sm btn-block btn-sm" value="Create Day Schedule">
							</div>
						</div>
					</form>
				</div>
		...
		<div class="col-md-7">
			...
			<div class="card">
				...
				<div class="card-body">
					<table id="example1" class="table  table-striped table-borderless table-hover">
						<thead>
						<th>#</th>
						<th>Instructor</th>
						<th>Course </th>
